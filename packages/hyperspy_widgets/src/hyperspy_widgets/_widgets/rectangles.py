...
from ..widget import ResizersMixin, Widget2DBase
...
class SquareWidget(Widget2DBase):
    ...
    def __init__(self, axis_source=None, **kwargs):
        super(SquareWidget, self).__init__(axis_source=axis_source, **kwargs)
...
class RectangleWidget(SquareWidget, ResizersMixin):
    ...
    def __init__(self, axis_source=None, **kwargs):
        super(RectangleWidget, self).__init__(axis_source=axis_source, **kwargs)
    ...
    @property
    def width(self):
        return self.get_size_in_index_units()[0]

    @width.setter
    def width(self, value):
        if value == self.width:
            return
        ix = self.index_position[0] + value
    ...
    @property
    def height(self):
        return self.get_size_in_index_units()[1]

    @height.setter
    def height(self, value):
        if value == self.height:
            return
        iy = self.index_position[1] + value
